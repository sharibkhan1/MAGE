...
export default function Home({ params }: { params: { name: string } }) {
  ...
  return (
    <div className="h-screen w-screen dark-shadow ">
      <SidebarProvider>
        <AppSidebar />
        <main>
          <SidebarTrigger />
  ...
  <IoMdClose size={20} />
    ...
    cardData.map((card, cardIndex) => (
      <BackdropGradient
        ...
        >
      <div key={cardIndex} className="border p-4 bg-grid-small-white/[0.3] border-white/40 bg-black text-white  rounded-lg shadow-lg">

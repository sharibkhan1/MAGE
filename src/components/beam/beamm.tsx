...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-3xl border bg-black p-10 md:shadow-xl",
        className
      )} style={{
        boxShadow: "inset 0 0 70px -10px #00ffff, inset 0 -2px 0 0 transparent",
      }}
      ref={containerRef}
    >

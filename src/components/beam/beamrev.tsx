...
export function AnimatedBeamMultipleOutputDemo2({
  className,
}: {
  className?: string;
}) {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-2xl border bg-black p-10 md:shadow-xl",
        className,
      )}
      style={{
        boxShadow: "inset 0 0 70px -10px #ffa500, inset 0 -2px 0 0 transparent",
      }}
      ref={containerRef}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-16">
            <img src="/exe logo2.png" className="h-full w-full object-contain" alt=""></img>
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          ...
          <Circle ref={div2Ref}>
          <img src="/vect/faiss.png" className="h-full w-full object-contain" alt=""></img>
          </Circle>
          <Circle ref={div3Ref}>
            <Icons.openai />
          </Circle>
          <Circle ref={div4Ref}>
          <img src="/vect/pinecone.png" className="h-full w-full object-contain" alt=""></img>
          </Circle>
          <Circle ref={div5Ref}>
            <Icons.notion />
          </Circle>

...
const StepTwo: React.FC<StepTwoProps> = ({ onBack, onNext, step }) => {
  ...
  return (
    <div className="flex flex-row w-[100%] h-[100%] " >
        ...
        <Button variant="outline" className={step === 3 ? " px-8 py-0.5  dark:text-white  border-2 border-black dark:border-white uppercase ethereal-chill z-[4] text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)]" : ""}>
        Embedding Models
        </Button>
        <Button variant="outline" disabled={isModelConfigured} className="dark:text-white border-white px-8 py-0.5">
        Data Loaders
      ...
      <div className="flex-1 z-[4] p-8 rounded-lg ml-4">
      ...
      <CardContainer>  
        <CardBody
          className={`bg-black mt-5 w-[20rem] h-[20rem] group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] shadow-lg rounded-lg flex flex-col justify-center items-center cursor-pointer border border-[#ffd078ab] ${isModelConfigured ? "opacity-70 cursor-not-allowed" : ""}`}
          style={{
        ...
        >
          ...
          <CardItem
            as="p"
            translateZ="60"
            className="text-center text-white border-t-2 dark:border-t-[#ffd078ab] w-[50%] border-t-[#ffd078ab] mt-4 text-lg font-semibold"
          >
            {model}
          </CardItem>
        </CardBody>
